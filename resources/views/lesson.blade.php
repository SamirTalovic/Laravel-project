          ...
          <div class="watch-data-right" id="watch-data-right">
            ...
            @if(!$purchased_course)
                ...
                @else
                    ...
                    class="button detail-button" style="text-align: center;">Kupite kurs (${{ $lesson->course->price }})</a>
                @endif
            @endif
          </div>
        </div>
        ...
        @if ($purchased_course)
          @if ($test_exists)
            @if (!is_null($test_result))
                  <div class="alert alert-info">Tvoj skor na testu: {{ $test_result->test_result }}</div>
            @else
