        ...
        <div class="detail-container grid">
          ...
          <div class="detail-data-right">
              ...
              <li>
                ...
                <?php else: ?>   
                  <?php if(!$purchased_course): ?>
                    <a class="lesson-title" aria-disabled="false" style="cursor:  alias" href="#"><i class='bx bx-lock'></i>Drugi kurs <?php echo e($lesson->count()); ?></a>
                  <?php else: ?>  
                    <a class="lesson-title" href="<?php echo e(route('lessons.show', [$lesson->course_id, $lesson->slug])); ?>"><i class="bx bx-play-circle"></i><?php echo e($lesson->title); ?></a>
                  <?php endif; ?>
                <?php endif; ?> 
            ...
            <?php else: ?>
                ...
                class="button detail-button" style="text-align: center;">Kupite kurs ($<?php echo e($course->price); ?>)</a>
            <?php endif; ?>
          </div>
        </div>
      </section>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Samir123\Desktop\xampp\htdocs\ProjectWP\resources\views/course.blade.php ENDPATH**/ ?>