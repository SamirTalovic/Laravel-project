                ...
                <?php if(auth()->check()): ?>
                    <?php if($lesson->course->students()->where('user_id', auth()->id())->count() == 0): ?>
                        ...
                        <?php echo csrf_field(); ?>
                            ...
                            <button class="button detail-button">Kupite kurs</button>
                        </form>
                    <?php endif; ?>
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>?redirect_url=<?php echo e(route('courses.show', [$lesson->course->slug])); ?>"
                    class="button detail-button" style="text-align: center;">Kupite kurs ($<?php echo e($lesson->course->price); ?>)</a>
                <?php endif; ?>
            <?php endif; ?>
          </div>
        </div>
        ...
        <?php if($purchased_course): ?>
          <?php if($test_exists): ?>
            <?php if(!is_null($test_result)): ?>
                  <div class="alert alert-info">Tvoj skor na testu: <?php echo e($test_result->test_result); ?></div>
            <?php else: ?>
            ...
            <?php echo csrf_field(); ?>
              ...
              <button class="button" 
                style="border: none; padding: 0.4rem 1.4rem; border-radius: 1rem;margin-top: 1rem;" >Potvrdi rezultat</button>
            </form>
            <?php endif; ?>
          <?php endif; ?>
        <?php endif; ?>
        ...
        <div class="rating-data">
          ...
          <?php echo csrf_field(); ?>
            ...
            >
              ...
              <option value="2">2 - Ne tako dobro</option>
              <option value="3">3 - Prosečno</option>
              <option value="4" selected>4 - Veoma dobro</option>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Samir123\Desktop\xampp\htdocs\ProjectWP\resources\views/lesson.blade.php ENDPATH**/ ?>