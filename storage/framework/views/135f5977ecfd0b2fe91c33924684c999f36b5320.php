        ...
        <form action="<?php echo e(route('admin.tests.update', $test->id)); ?>" method="POST">
            ...
            <div class="form-group <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
                ...
                <select name="course_id" class="form-control" id="teacher" >
                    <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php echo e($id == $test->course_id ? "selected" : null); ?>  value="<?php echo e($id); ?>"><?php echo e($course); ?></option>
            ...
            <div class="form-group <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
                ...
                <select name="lesson_id" class="form-control" id="lesson_id" >
                    <?php $__currentLoopData = $lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php echo e($id == $test->lesson_id ? "selected" : null); ?> value="<?php echo e($id); ?>"><?php echo e($lesson); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group <?php echo e($errors->has('published') ? 'has-error' : ''); ?>">
                ...
                <select name="published" class="form-control" id="published">
                    <option <?php echo e($test->published == 1 ? 'selected' : null); ?> value="1">Aktivan</option>
                    <option <?php echo e($test->published == 0 ? 'selected' : null); ?> value="0">Neaktivan</option>
                </select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Samir123\Desktop\xampp\htdocs\ProjectWP\resources\views/admin/tests/edit.blade.php ENDPATH**/ ?>