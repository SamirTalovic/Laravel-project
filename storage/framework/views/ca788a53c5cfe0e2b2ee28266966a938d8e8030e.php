<?php $__env->startSection('content'); ?>
    <section class="products section container" id="course">
        <h2 class="section-title">Moj kurs</h2>
        ...
        <div class="featured-container grid">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <h2 style="text-align: center;grid-column: 1/5">Još nisi kupio kurs</h2>
            <?php endif; ?>
            </div>
      </section>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Samir123\Desktop\xampp\htdocs\ProjectWP\resources\views/courses.blade.php ENDPATH**/ ?>