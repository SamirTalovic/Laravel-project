<?php $__env->startSection('content'); ?>
    ...
    <div class="title d-flex justify-content-between">
        ...
        <p >
            <a href="<?php echo e(route('admin.tests.create')); ?>" class="btn btn-success">Dodaj novi</a>
    ...
    <p class="m-0">
        <ul class="d-flex list-unstyled" style="column-gap: 1rem">
            <li><a href="<?php echo e(route('admin.tests.index')); ?>" style="<?php echo e(request('show_deleted') == 1 ? '' : 'font-weight: 700'); ?>">Svi</a></li> |
            <li><a href="<?php echo e(route('admin.tests.index')); ?>?show_deleted=1" style="<?php echo e(request('show_deleted') == 1 ? 'font-weight: 700' : ''); ?>">Korpa</a></li>
        </ul>
    </p>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Samir123\Desktop\xampp\htdocs\ProjectWP\resources\views/admin/tests/index.blade.php ENDPATH**/ ?>